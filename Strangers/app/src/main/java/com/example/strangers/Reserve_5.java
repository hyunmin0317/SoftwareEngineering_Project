    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel01.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    AlertDialog.Builder dlg = new AlertDialog.Builder(Reserve_5.this);
...
//                버튼 클릭시 동작
                    dlg.setPositiveButton("확인",new DialogInterface.OnClickListener(){
                        public void onClick(DialogInterface dialog, int which) {
                            //토스트 메시지
                            Toast.makeText(Reserve_5.this,"예약이 정상적으로 취소 되었습니다.",Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(Reserve_5.this,MainHomeActivity.class);
